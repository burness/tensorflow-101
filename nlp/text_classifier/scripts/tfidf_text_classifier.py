...
class tfidf_text_classifier:
    ...
    def split_train_test(self):
        self.train_set, self.test_set, self.train_tag, self.test_tag = train_test_split(self.tfidf, self.labels, test_size=0.2)
...
if __name__ == "__main__":
    bow_text_classifier_obj = tfidf_text_classifier("../data/origin_data/all.csv")
